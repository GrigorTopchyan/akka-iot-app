...
public class IotAppTest {
    ...
    public void testRegisterDeviceActor(){
        ...
        groupActor.tell(new DeviceManager.RequrstTrackDevice("group","device1"),probe.testActor());
        probe.expectMsgClass(DeviceManager.DeviceRegistered.class);
        ActorRef deviceActor1 = probe.lastSender();

        groupActor.tell(new DeviceManager.RequrstTrackDevice("group","device2"),probe.testActor());
        probe.expectMsgClass(DeviceManager.DeviceRegistered.class);
    ...
    public void testIgnoreRequestsForWrongGroupId(){
        ...
        groupActor.tell(new DeviceManager.RequrstTrackDevice("wrongGroup","device1"),probe.testActor());
        probe.expectNoMessage();
    }
